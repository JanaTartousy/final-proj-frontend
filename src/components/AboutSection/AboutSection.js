  ...
  return (
    <div className="about-dalili">
      <div className="dalili-content">
        ...
        <p className="about-us-paragraph">
          With our experienced guides and carefully curated itineraries, we
          invite you to embark on a journey of discovery through Lebanon's
          ancient ruins, vibrant cities, and natural wonders. From exploring the
          UNESCO World Heritage Sites to indulging in the delicious flavors of
          Lebanese cuisine, our aim is to provide you with an unforgettable and
        ...
        <p className="about-us-paragraph">
          ...
          its rich history, captivating landscapes, and welcoming culture. Let
          us be your trusted guide, creating memories that will last a lifetime.
        </p>
      </div>
    </div>
  );
